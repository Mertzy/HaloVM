...
#choice.
#
#This virtual machine is designed with speed in mind. Methods are reduced as much as possible
#in an attempt to obtain "order of n" complexity. This makes the VM much easier to implement
